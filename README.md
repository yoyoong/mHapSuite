...
Example of usage:
```Shell
java -jar mHapSuite-1.0-jar-with-dependencies.jar genomeWide -tag test -mhapPath esophagus_T.mhap.gz -cpgPath hg19_CpG.gz -metrics Cov MM PDR CHALM MHL MCR MBS R2 -outputDir outputDir -minK 1 -maxK 10 -K 4 -strand both -cpgCov 5 -r2Cov 20 -k4Plus 5 
