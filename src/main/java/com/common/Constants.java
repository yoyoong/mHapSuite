...
final public class Constants {
    ...
    public static final String CPGPATH_DESCRIPTION = "genomic CpG file, gz format and indexe";
    public static final String REGION_DESCRIPTION = "one region, in the format of chr:start-end";
    public static final String BEDPATH_DESCRIPTION = "a bed file, one query region per lin";
