...
public class TanghuluArgs implements Serializable {
    ...
    @Annotation("the max number of reads to plot [50]")
    public Integer maxReads = 50; 
    @Annotation("the max length of region to plot [2000]")
    public Integer maxLength = 2000; 
    @Annotation("indicates whether identical mHaps should be merged")
    public Boolean merge = false; 
    @Annotation("indicates whether mHaps should be simulated")
